...
(function () {
    ...
    function injectStyles() {
        ...
        css += '\n@media (max-width:' + BREAKPOINT + 'px) {\n' + [
            ...
            '  .top-bar button {',
            '    width:auto !important; padding:4px 7px !important; font-size:0.75em !important;',
            '    white-space:nowrap !important; margin:1px 2px !important;',
